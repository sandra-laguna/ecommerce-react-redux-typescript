  ...
  return (
    <>
      <Button variant="outlined" onClick={handleOpen} sx={{ textTransform: "capitalize" }}>
        <LoginIcon sx={{ height: "20px", marginRight: "10px" }} />
        Login
      </Button>
      ...
      <Dialog open={open} onClose={handleClose}>
        ...
        <DialogContent sx={{ padding: "0 24px" }}>
          <Button variant="contained" sx={{ width: "100%", marginBottom: "20px" }}>
            <Google sx={{ height: "20px", marginRight: "10px" }} /> Sign in with Google
          </Button>
          <Button variant="contained" sx={{ width: "100%", marginBottom: "20px" }}>
            <Facebook sx={{ height: "20px", marginRight: "10px" }} /> Sign in with Facebook
          </Button>
